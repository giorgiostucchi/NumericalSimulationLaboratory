...
//cambiare il ciclo di equilibrazione a seconda della fase prescelta

int main()
{ 
  Input(); //Inizialization
  for(int index = 0; index <= 100000; index++){Move();}; //include ciclo sui timestep per equilibrazione   2000 per solidi e liquidi, 100000 per gas  
  int nconf = 1;
  ConfXYZ(nconf);
  nconf += 1;
