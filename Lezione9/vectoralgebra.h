...
// ===============================================================================
// divisione tra uno scalare e un vettore 
// ===============================================================================
template <typename T> std::vector<T> operator/(T c, const std::vector<T>& a) {
    std::vector<T> result(a.size());
...
template <typename T> T NormEuclidean(const std::vector<T> &a) {
...
template <typename T> T NormEuclidean(const std::pair<T, T> &p) {
  return std::sqrt(std::pow(p.first, 2) + std::pow(p.second, 2));
}
